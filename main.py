...
# Словарь правил
FORWARD_RULES = {
    "Бот Playerok не является чатом и предназначен только для отправки уведомлений с сайта.
Перейдите в чаты на сайте, чтобы отправить сообщение": TOPIC_PAYMENT,
